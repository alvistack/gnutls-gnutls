...
%package -n libgnutlsxx28
Summary: GNU TLS library - C++ runtime library

%description -n libgnutlsxx28
...
Requires: libgnutlsxx28 = %{epoch}:%{version}-%{release}
...
%post -n libgnutlsxx28 -p /sbin/ldconfig
%postun -n libgnutlsxx28 -p /sbin/ldconfig
